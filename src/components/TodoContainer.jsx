  ...
  return (
    <div className="flex fades flex-col mt-[-90px] justify-center md:mt-[-90px]  z-1000 relative w-full md:p-0 mx-auto  max-w-lg items-center md:mx-auto">
      <div
        className={`fades ${
          theme === "light"
            ? "bg-white fades !text-black"
            : "fades bg-[hsl(235,_24%,_19%)] !text-white"
        } fades  relative w-[90%] shadow-md mb-4 md:w-full md:!mx-[26px] md:max-w-[450px] rounded-sm flex justify-start gap-4 px-4  py-3`}
      >
      ...
      <div className="md:w-full w-[90%]  mx-auto flex justify-center items-center flex-col md:max-w-[450px]">
        {todos.length > 0 &&
          todos.map((todo) => (
            <div
              className={`w-full  md:mx-auto fades  ${
                theme === "light"
                  ? "!bg-white border border-t-0 border-r-0 border-l-0 border-b-[#999] fades text-black "
                  : "text-white  border-[1px]  border-b-[#fafafa28] border-t-0 border-r-0 border-l-0 fades bg-[hsl(235,_24%,_19%)]"
              }  `}
              key={todo.id}
            >
              ...
              {pages === "all" && (
                ...
                >
                  ...
                  <span
                    ...
                    className={` cursor-pointer${
                      todo.completed
                        ? " italic line-through  cursor-pointer text-gray-400"
                        : " cursor-pointer"
                    }`}
                  >
                    {todo.text}
          ...
          {todos.length === 0 ? (
            ...
            <div
              className={` ${
                theme === "light"
                  ? "bg-white"
                  : "bg-[hsl(235,_24%,_19%)] text-white"
              }  shadow-lg rounded-sm flex max-w-[400px] w-[350px] md:mx-auto md:justify-start gap-3 md:w-full items-center px-4 py-3 mt-2`}
            >
              ...
              <span
                ...
                className="text-gray-400 md:ml-0 ml-auto cursor-pointer"
              >
                Clear completed
              </span>
            </div>
        ...
        <div
          className={`flex w-full md:hidden mt-5 ${
            theme === "light"
              ? "bg-white"
              : "bg-[hsl(235,_24%,_19%)] text-white"
          }   rounded-sm shadow-sm p-2 gap-4 font-semibold text-gray-400 justify-center`}
        >
          <p
            className={`cursor-pointer ${
              pages === "all" ? "text-blue-500" : ""
            }`}
            onClick={() => {
              setPages("all");
            }}
